...
```{r o1, warning=FALSE, message=FALSE, cache=TRUE}
# Getting one-sample.
set.seed(123)
x_1 <- rnorm(100, 0, 1) 
...
$$~$$
```{r o2, warning=FALSE, message=FALSE, cache=TRUE}
# MSE
...
```{r o3, warning=FALSE, message=FALSE, cache=TRUE}
...
```{r o4, warning=FALSE, message=FALSE, cache=TRUE}
# New Table
tabb <- matrix(0, 4, 3)
